...
setup(
    ...
    keywords=['python', 'yuno', 'database', 'database-management', 'mongo', 'mongodb',
              'account', 'account-management', 'database-client', 'client', 'mongo-client'],
    install_requires=['pymongo>=3.11.3', 'psutil>=5.8.0', 'PyYAML>=6.0', 'argon2_cffi>=20.1.0',
                      'pyjwt>=2.0.1', 'pycryptodome>=3.10.1', 'typing; python_version<"3.8"'],
